################################################################################
# Windows NT 5.0 (aka Windows 2000) specific variables
#
# This is the Makeconf platform specific part for CONTEXT=x86_nt_5
#
...
#
PKG_CONTROL_DIR=${SANDBOXBASE}/inst.images/${CONTEXT}/mdata/OdeHello
PKG_CONTROL_DIR%=${PKG_CONTROL_DIR}
TOSTAGE=${SANDBOXBASE}/inst.images/${CONTEXT}/mdata/OdeHello

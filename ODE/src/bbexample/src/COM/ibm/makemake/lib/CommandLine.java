...
import COM.ibm.makemake.lib.StringTools;
import COM.ibm.makemake.lib.Version;
...
public class CommandLine
{
  ...
  **/
  ...
  public static void printVersion(String program)
  {
    ...
    Interface.printAlways("version : " + Version.VERSION);
    Interface.printAlways("built   : " + Version.BUILD_DATE);
  }
}

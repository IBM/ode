...
/**
 * This menu action displays a dialog box where the user can choose to
 * modify certain characteristics of a sandbox or backing build.
 * These can include making it the default sandbox (-def) or adding a
 * machine (-m).
**/
class SLModifyCmd implements SLAction
{
...
//      {
        JOptionPane.showMessageDialog( frame, 
                            "The 'Modify' menu item is not implemented yet!",
                                       "Modify sandbox",

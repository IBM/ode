...
//LVW new Attribute Object to represent the PackageData Stanza

public class PkgDataAttribObject extends AttributeObject
{
  private ArrayList attribTokenArray_;
  private ArrayList attribTypeArray_;

  public PkgDataAttribObject( ParserGeneratorEnumType pgEnum )
  {
    /**
     ...
     **/
     ...
     attribTokenArray_.add( new Integer(pgEnum.getInt("sysLibsLibraryDD")));
     ...
     while( attribTokenIterator.hasNext() )
     {
       ...
       else if (arrayValue.intValue() == pgEnum.getInt("sysLibsLibraryDD"))
       {
           attribTypeArray_.add(new Integer(pgEnum.getInt("ListOfString")));	     
       }

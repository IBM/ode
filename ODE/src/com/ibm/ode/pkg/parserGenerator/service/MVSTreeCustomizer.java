...
**/
public class MVSTreeCustomizer implements TreeCustomizer
{
   /**********************************************************************
   * This method returns the tree cutomizer to be used with this NodeHandler. 
   * @return int TreeCustomizer The TreeCustomizer to be used with this NodeHandler. 
   **/
  TreeCustomizer getCustomizer()
  {

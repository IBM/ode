 ...
 * @author sdmcjunk
 * 
 * This class is meant to remove the ODE nature from a project.
 * This action is available through an ODE menu that is availble when a Java,
 * C or C++ project is selected that has an ODE nature association.
 *
 */
public class RemoveProjNatureActionDelegate implements IObjectActionDelegate 
{

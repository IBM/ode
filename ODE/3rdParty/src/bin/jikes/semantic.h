...
public:
                                                            ...
                                                            definite_visible_variables(NULL)
    {
        ...
        ProcessBinaryExpr[AstBinaryExpression::PLUS]                 = &Semantic::ProcessBINPLUS;
        ...
        ProcessBinaryExpr[AstBinaryExpression::MINUS]                = &Semantic::ProcessBINMINUS;
...
private:
    ...
    void ProcessBINPLUS(AstBinaryExpression *);
    ...
    void ProcessBINMINUS(AstBinaryExpression *);
